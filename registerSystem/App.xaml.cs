...
public partial class App : Application
{
    ...
    private static void ApplyScreenScale()
    {
        ...
        Current.Resources["FontSideBtn"]       = Math.Round(20 * scale);
        Current.Resources["BtnSizeNav"]        = Math.Round(80 * scale);
        Current.Resources["BtnSizeSide"]       = Math.Round(120 * scale);
        Current.Resources["BtnSideMargin"]     = Math.Round(20 * scale);
